 ...
 */
MapTo('dd/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('dd/components/separator')(SeparatorV1Component);

MapTo('dd/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('dd/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('dd/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('dd/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('dd/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('dd/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('dd/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('dd/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('dd/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('dd/components/accordion')(AccordionV1Component);
MapTo('dd/components/tabs')(TabsV1Component);
...
LazyMapTo('dd/components/teaser')(TeaserV1Component);
...
LazyMapTo('dd/components/carousel')(CarouselV1Component);
...
LazyMapTo('dd/components/text')(LazyTextModule, TextEditConfig);